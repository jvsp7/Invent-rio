...
public class ProductTester {
        ...
        public static void main(String[] args) {
            ...
            if(maxSize ==0) {
                  ...
                  Produto[] products = new Produto[maxSize];
    ...
    static void executeMenuChoice(int choice, Produto[] products, Scanner in) {
            switch(choice) {
...
static void discontinueInventory(Produto[] products, Scanner in) {
int productChoice;
...
static void deductInventory(Produto[] products, Scanner in) {
int productChoice;
int updateValue= -1;
productChoice=getProductNumber(products, in);
do {
...
static void addInventory(Produto[] products, Scanner in) {
int productChoice;
int updateValue=-1;
productChoice=getProductNumber(products, in);
do {
...
static int getProductNumber(Produto[] products, Scanner in) {
int productChoice=-1;
...
static void addToInventory(Produto[] products, Scanner in) {
...
static void addCDToInventory(Produto[] products, Scanner in, int i) {
//criar variáveis locais
int tempNumber;
String tempName;
int tempQty;
...
static void addDVDToInventory(Produto[] products, Scanner in, int indexValue) {
//criar variáveis locais
int tempNumber;
String tempName;
int tempQty;
...
static void displayInventory(Produto[] products) {
//exibir o conteúdo do array de produtos
